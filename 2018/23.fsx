...
//     let nbList = calculateNeighbors nanobots
//     let nbSet = nbList |> Set.ofList
//     let nbMap = nbList |> List.map (fun n -> (n.Id,n)) |> Map.ofList
//     let maximalCliques =
...
// //976, 51429369
// cadd (minX-17000000,minY-17000000,minZ-17000000)
